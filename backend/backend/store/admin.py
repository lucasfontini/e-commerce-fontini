...
from store.models import CartOrderItem, CouponUsers, Notification, Product ,Category, Cart, DeliveryCouriers, CartOrder, Gallery, ProductFaq, Review,  Specification, Coupon, Color, Size, Address, Wishlist
